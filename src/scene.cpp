...
Scene gen_multi_rotating_cube_scene()
{
    ...
    Scene scene("../shaders/shader_file/v.vert", "../shaders/shader_file/f.frag");
    ...
    scene.textures.push_back(statue_texture);
    scene.textures.push_back(viking_texture);
    ...
    unsigned int transformLoc = glGetUniformLocation(scene.shader.ID, "transform");
